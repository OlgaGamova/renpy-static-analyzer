...
class GraphVisualizer:
    ...
    Внимание! Данный визуализатор (vis-network) не используется в основном веб-интерфейсе.
    Основная визуализация графа выполняется через Cytoscape.js во фронтенде.
    Оставлен для возможного автономного экспорта графа в HTML через консольный скрипт.
    """
